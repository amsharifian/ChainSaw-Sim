...
void Topology::makeFileSpecified()
{
  ...
  filename = filename + "_Procs-"+int_to_string(RubyConfig::numberOfProcessors())
    +"_ProcsPerChip-"; 
  filename = filename + int_to_string(RubyConfig::numberOfProcsPerChip());
  filename = filename + "_L2Banks-"+int_to_string(RubyConfig::numberOfL2Cache());
  filename = filename + "_Memories-"+int_to_string(RubyConfig::numberOfMemories()) +".txt";

...
class LRUPolicy : public AbstractReplacementPolicy {
 public:
  ...
  LRUPolicy(Index num_sets, Index assoc, Vector< Vector<ENTRY> > *cache_ref);
  ~LRUPolicy();
...
template <class ENTRY>
inline
LRUPolicy<ENTRY>::LRUPolicy(Index num_sets, Index assoc, Vector< Vector<ENTRY> > *cache_ref)
...
template <class ENTRY>
inline
LRUPolicy<ENTRY>::~LRUPolicy()
{
}

template <class ENTRY>
inline
void LRUPolicy<ENTRY>::touch(Index set, Index index, Time time ){

...
int MachineType_base_number(const MachineType& obj)
{
  ...
  case MachineType_L2Cache:
    return 0;
  case MachineType_L1Cache:
    return 0+RubyConfig::numberOfL2Cache();
  case MachineType_Directory:
    return 0+RubyConfig::numberOfL2Cache()+RubyConfig::numberOfL1Cache();
  case MachineType_NUM:
    return 0+RubyConfig::numberOfL2Cache()+RubyConfig::numberOfL1Cache()+RubyConfig::numberOfDirectory();
  default:
    ERROR_MSG("Invalid range for type MachineType");
    return -1;
  }

...
public:
  ...
  // This should be L2Cache_Entry to be correct. The reason this was
  // lying there wand not throwing an error is because after initialization
  // in Chip the vector was never reassigned back to the Abstract chip
  // part.

  Vector < CacheMemory<L2Cache_Entry>* > m_L2Cache_L2cacheMemory_vec; // This is for MESI
  ...
  // More Prefetcher stuff
  Vector < GenericPrefetcher* > m_L2Cache_Prefetcher_vec;
  Vector < MessageBuffer* > m_L2Cache_optionalQueue_vec;
  Vector < GenericPrefetcher* > m_L1Cache_Prefetcher_vec;
